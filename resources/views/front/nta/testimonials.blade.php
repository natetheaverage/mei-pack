{{-- ===========================
    ...
    ===========================  --}}
    <div id="testimonials" class="nta-component">
        <div class="sectionhead wow fadeInUp" data-wow-duration=".5s">
        ...
        <div class="row">
            ...
            <div class="col-md-6 wow fadeIn" data-wow-duration=".5s">
                <div class="clientsphoto">
                    <img src="/images/nta/dan.jpg" alt="Dan">
                </div>
            ...
            <div class="col-md-6 wow fadeIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="/images/nta/bill.jpg" alt="Bill">
                </div>
            ...
            <div class="col-md-6 wow fadeIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="/images/nta/eric.png" alt="Eric">
                </div>
            ...
            <div class="col-md-6 wow fadeIn" data-wow-duration=".5s">
                <div class="clientsphoto">
                    <img src="/images/nta/ramil.jpg" alt="Ramil">
                </div>
