...
<div 
  ...
  >
    ...
    >
      <a href="/events/denver-winter-2016">
      <i class="fa fa-icon fa-arrow-left"></i> Denver Holiday Expo 2016
      </a>
      <a href="/events/greeley-spring-2016">Greeley Spring 2016 
      <i class="fa fa-icon fa-arrow-right"></i></a>
      
    </div>
      {{-- Title, Dates & Calendar Links --}}
      @include('partials.events.dates.desmoines-spring-2017')
