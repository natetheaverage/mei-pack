@extends('nest')
@section('title', 'Denver Winter 2016')
...
<div 
  ...
  >
    ...
    >
      <a href="/events/cheyenne-fall-2016">
      <i class="fa fa-icon fa-arrow-left"></i> Cheyenne Fall 2016
      </a>
      <a href="/events/desmoines-spring-2017">Des Moines Spring 2017 
      <i class="fa fa-icon fa-arrow-right"></i></a>
    </div>
    
          
      {{-- Title, Dates & Calendar Links --}}
      @include('front.partials.events.dates.denver-winter-2016')
          ...
          <div class="container" style="border-bottom: 1px solid #dbdbdb">
            <div class="section-header">
              ...
              <p class="text-center wow fadeInDown" v-html="truth.events[4].details"></p>
            </div>
            <div class="row">
              <div class="features">
                <div 
