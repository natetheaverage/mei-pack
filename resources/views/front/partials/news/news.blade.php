<div class="pad-all">
  ...
  <div class="row">
    <div class="col-sm-6">
        <div class="news-post news-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
        <article>
            <header class="entry-header">
                <div class="entry-thumbnail">
                    <img class="img-responsive" src="images/frontImages/news/01.jpg" alt="">
  ...
  <div class="col-sm-6">
    <div class="news-post news-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
        <article class="media clearfix">
            <div class="entry-thumbnail pull-left">
                <img class="img-responsive" src="images/frontImages/news/02.jpg" alt="">
    ...
    <div class="news-post news-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
        <article class="media clearfix">
            <div class="entry-thumbnail pull-left">
                <img class="img-responsive" src="/images/frontImages/news/03.jpg" alt="">
